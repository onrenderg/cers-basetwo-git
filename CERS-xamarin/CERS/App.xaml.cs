...
namespace CERS
{
    public partial class App : Application
    {
        ...
        public App()
        {
            ...
            //Preferences.Set("BasicAuth", $"{HttpUtility.UrlEncode(AESCryptography.EncryptAES("CERS"))}:{HttpUtility.UrlEncode(AESCryptography.EncryptAES("9JO9G3C7F05ZG1104"))}");


            /*string ud = "CERS" + DateTime.Now.ToString("dd/MM/yyyy HH:mm:ss");
            string eud = HttpUtility.UrlEncode(AESCryptography.EncryptAES(ud)) ;*/
            Preferences.Set("BasicAuth", 
               // $"{HttpUtility.UrlEncode(AESCryptography.EncryptAES("CERS" + DateTime.Now.ToString("dd/MM/yyyy HH:mm:ss")))}" +
                $"{HttpUtility.UrlEncode(AESCryptography.EncryptAES("CERS"))}" +
                $":{HttpUtility.UrlEncode(AESCryptography.EncryptAES("9JO9G3C7F05ZG1104"))}");
      ...
      /*  public static string basic_auth()
        {
            return $"{HttpUtility.UrlEncode(AESCryptography.EncryptAES("CERS" + DateTime.Now.ToString("dd/MM/yyyy HH:mm:ss")))}" +
                $":{HttpUtility.UrlEncode(AESCryptography.EncryptAES("9JO9G3C7F05ZG1104"))}";
        }*/
