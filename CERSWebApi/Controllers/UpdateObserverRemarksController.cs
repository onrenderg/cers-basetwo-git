...
{
    public class UpdateObserverRemarksController : ApiController
    {
...
#endif
        //save deatils
        public HttpResponseMessage Post(ObserverRemarks_update items)
        {
            ...
            try
            {
                ...
                dt = objDBAccess.getDBData(cmd, "sec.Mobile_updateobserverremarks");
                if (dt.Rows.Count > 0)
                {
