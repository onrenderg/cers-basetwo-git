...
{
    public partial class SaveExpenditureDetails : System.Web.UI.Page
    {
        ...
        string AutoID, expDate, expCode, amtType, amount, amountoutstanding, paymentDate, voucherBillNumber, payMode, payeeName,
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //string AutoIDdecoded = DecryptAES(HttpUtility.UrlDecode(AutoID)); 
            ...
            {
                dbconnection.Open();
                SqlCommand cmd = new SqlCommand("sec.Mobile_saveData", dbconnection);             
                ...
                {
                   // cmd.Parameters.AddWithValue("@evidenceFile", Convert.FromBase64String(HttpUtility.UrlDecode(data)));
